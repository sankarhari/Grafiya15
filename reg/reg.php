...
<head>
  ...
  <meta http-equiv="refresh" content="4.6;URL=http://reg.grafiya15.in/">
...
$sql="insert into reg(name,email,phone,college,dept,year,pay) values('".$_REQUEST['name']."', '".$_REQUEST['email']."','".$_REQUEST['phone']."','".$_REQUEST['college']."','".$_REQUEST['dept']."','".$_REQUEST['year']."','".$_REQUEST['pay']."')";
...
@mail($email_to,$email_mes, $email_subject,$headers);  
 ?><div class="container"><div class="container">
  <div class="jumbotron">
	...
	<p>Grafiya ID is :<?php echo"GRF'$no'"; ?></p>
  </div>      
</div></div>
